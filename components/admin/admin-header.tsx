...
const contextMenus: Partial<Record<AdminShellArea, readonly { label: string; href: string }[]>> = {
  ...
  'reuniao-publica': [
    ...
    { label: 'Catálogo', href: '/admin/reuniao-publica/musicas' },
    { label: 'Autores', href: '/admin/reuniao-publica/musicas/autores' },
    { label: 'Sessões', href: '/admin/reuniao-publica/musicas/sessoes' },
