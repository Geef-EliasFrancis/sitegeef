    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Evangelho no Lar para estudo e convivência familiar.",
          "Transmissões ao vivo quando houver evento.",
        ],
      },
      {
        heading: "Evangelho no Lar",
        text: "Uma reunião familiar regular, em dia e horário combinados, para cultivar o estudo do Evangelho, a fraternidade e a paz no ambiente doméstico.",
        bullets: [
          "Comece com uma prece simples e espontânea.",
          "Leia um trecho de O Evangelho segundo o Espiritismo.",
          "Conversem brevemente sobre a aplicação moral do texto no dia a dia.",
          "Finalize com vibrações fraternas e uma prece de encerramento.",
          "A casa pode orientar famílias interessadas na implantação dessa prática.",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        bullets: ["Música — harmonização do ambiente", "Avisos", "Leitura", "Prece inicial", "Palestra", "Prece final", "Passe espiritual", "Lanche comunitário gratuito, sempre que possível."],
      },
      {
