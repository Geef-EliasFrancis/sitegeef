...
const responsiveContract = [
  ...
  ['top menu interno verde possui contraste forte', adminCss.includes('border-bottom: 3px solid #174d0b') && adminCss.includes('color: #102a0c') && adminCss.includes('text-shadow: 0 1px 0 rgba(255, 255, 255, 0.68)')],
