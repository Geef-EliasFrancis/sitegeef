...
const responsiveContract = [
  ...
  ['submenu de músicas possui retorno para reunião', publicSiteHeaderSource.includes('{ href: "/reuniao-publica", label: "Reunião" }') && publicSiteHeaderSource.includes('label: "Músicas"') && !publicSiteHeaderSource.match(/const musicLinks = \[[\s\S]{0,220}musicas\/exibir/) && publicSiteHeaderCss.includes('.site-context-navigation--music .site-context-navigation-copy {')],
