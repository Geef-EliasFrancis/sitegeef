...
const responsiveContract = [
  ...
  ['submenu de músicas não duplica título nem ao vivo', publicSiteHeaderSource.includes('const musicLinks = [') && !publicSiteHeaderSource.match(/const musicLinks = \[[\s\S]{0,180}musicas\/exibir/) && publicSiteHeaderCss.includes('.site-context-navigation--music .site-context-navigation-copy {')],
