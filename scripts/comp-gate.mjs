...
const responsiveContract = [
  ...
  ['player de passes possui aleatório e repetição', musicPassesPlayerSource.includes('shuffle') && musicPassesPlayerSource.includes('repeatMode') && musicPassesPlayerSource.includes('useState<RepeatMode>("all")') && musicPassesPlayerSource.includes('musica-passes-waveform')],
