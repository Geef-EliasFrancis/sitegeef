...
const responsiveContract = [
  ...
  ['programação remove selo institucional redundante', fs.readFileSync('app/programacao/page.tsx', 'utf8').includes('showBrandKicker={false}') && fs.readFileSync('components/content-page.tsx', 'utf8').includes('showBrandKicker?: boolean')],
