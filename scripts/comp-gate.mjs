...
const responsiveContract = [
  ...
  ['contatos usa tabela compacta sem cabecalho repetido', institutionContactsPageSource.includes('Canal') && institutionContactsPageSource.includes('instituicao-contato-table--group-head') && !institutionContactsPageSource.includes('Rede social') && globalsCss.includes('.instituicao-contato-table-row:nth-child(even)')],
