...
const responsiveContract = [
  ...
  ['músicas isolam catálogo e sessões do banco', musicRepositorySource.includes('saveMusicaRecord') && musicRepositorySource.includes('saveMusicaSessaoRecord') && musicRepositorySource.includes('patchMusicaSessaoRecord') && !musicasSource.includes('.from("musicas").upsert') && !musicasSource.includes('.from("musica_sessoes").upsert')],
