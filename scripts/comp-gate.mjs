...
const responsiveContract = [
  ...
  ['submenu público diferencia item ativo', publicSiteHeaderSource.includes('site-context-navigation-link${isContextLinkActive') && publicSiteHeaderSource.includes('if (isMusicPath && href === "/musicas") return pathname === "/musicas"') && publicSiteHeaderSource.includes('aria-current={isContextLinkActive') && publicSiteHeaderCss.includes('.site-context-navigation-link.is-active') && publicSiteHeaderCss.includes('.site-nav-dropdown-item.is-active')],
