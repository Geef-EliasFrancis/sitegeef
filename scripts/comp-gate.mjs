...
const responsiveContract = [
  ...
  ['contatos usa tabela de canal e informação', institutionContactsPageSource.includes('Rede social') && institutionContactsPageSource.includes('Informação') && institutionContactsPageSource.includes('instituicao-contato-table') && globalsCss.includes('grid-template-columns: minmax(8rem, 0.4fr) minmax(0, 1fr)')],
