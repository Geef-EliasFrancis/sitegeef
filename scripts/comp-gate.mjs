...
const responsiveContract = [
  ...
  ['músicas isolam leitura e escrita do catálogo', musicRepositorySource.includes('fetchMusicasBase') && musicRepositorySource.includes('saveMusicaRecord') && musicRepositorySource.includes('deleteMusicaRecord') && !musicasSource.includes('.from("musicas").upsert') && !musicasSource.includes('.from("musica_partes").insert')],
