...
const routes = ['/admin/painel', '/admin/reuniao-publica', '/admin/reuniao-publica/avisos', '/admin/reuniao-publica/musica/inicio', '/admin/reuniao-publica/musica/catalogo', '/admin/escalas', '/admin/financeiro'];
const viewports = [
