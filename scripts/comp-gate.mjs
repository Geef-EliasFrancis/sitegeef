...
const responsiveContract = [
  ...
  ['ao vivo pertence ao acesso principal de músicas', publicMusicasToolbarSource.includes('href="/musicas/exibir"') && siteHeaderSource.includes('const musicLinks') && siteHeaderSource.includes('const isMusicPath') && !siteHeaderSource.match(/const musicLinks = \[[\s\S]{0,180}musicas\/exibir/)],
  ...
  ['submenu de músicas usa nome curto sem ao vivo', publicSiteHeaderSource.includes('const musicLinks = [') && publicSiteHeaderSource.includes('label: "Músicas"') && !publicSiteHeaderSource.match(/const musicLinks = \[[\s\S]{0,180}musicas\/exibir/) && publicSiteHeaderCss.includes('.site-context-navigation--music .site-context-navigation-copy {')],
