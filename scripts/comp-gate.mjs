...
const responsiveContract = [
  ...
  ['avatar admin reutiliza imagem do perfil', adminUserMenuSource.includes('avatarUrl?: string') && adminUserMenuSource.includes('admin-user-menu-avatar-image') && adminHeaderSource.includes('avatarUrl?: string') && fs.readFileSync('app/admin/layout.tsx', 'utf8').includes('avatarUrl: user.user_metadata?.avatar_url')],
