...
const responsiveContract = [
  ...
  ['contatos remove WhatsApp da apresentacao', !institutionContactsPageSource.match(/\["whatsapp",\s*"WhatsApp"\]/) && institutionContactsPageSource.includes('tipo !== "WhatsApp"') && institutionContactsPageSource.includes('instituicao-contato-card--untitled')],
